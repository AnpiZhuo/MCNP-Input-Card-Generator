    ...
    React.createElement("div", { style: { border: "1px solid var(--border-glass)", borderRadius: 8, padding: 12, marginBottom: 12 } },
      ...
      React.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" } },
        ...
        React.createElement("div", { style: { ...grp, maxWidth: 110 } },
          ...
          React.createElement("select", { style: { ...inp, height: 32 }, value: ssw.sym, onChange: (e: React.ChangeEvent<HTMLSelectElement>) => onChangeSsw({ ...ssw, sym: e.target.value }) },
        ...
        React.createElement("div", { style: { ...grp, maxWidth: 90 } },
          ...
          React.createElement("select", { style: { ...inp, height: 32 }, value: ssw.pty, onChange: (e: React.ChangeEvent<HTMLSelectElement>) => onChangeSsw({ ...ssw, pty: e.target.value }) },
    ...
    React.createElement("div", { style: { border: "1px solid var(--border-glass)", borderRadius: 8, padding: 12 } },
      ...
      React.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" } },
        React.createElement("div", { style: { ...grp, maxWidth: 90 } },
          ...
          React.createElement("select", { style: { ...inp, height: 32 }, value: ssr.mode, onChange: (e: React.ChangeEvent<HTMLSelectElement>) => onChangeSsr({ ...ssr, mode: e.target.value }) },
        ...
        React.createElement("div", { style: { ...grp, maxWidth: 110 } },
          React.createElement("label", { style: lbl }, "PTY 粒子"),
          React.createElement("select", { style: { ...inp, height: 32 }, value: ssr.pty, onChange: (e: React.ChangeEvent<HTMLSelectElement>) => onChangeSsr({ ...ssr, pty: e.target.value }) },
            React.createElement("option", { value: "" }, "全部"),
            React.createElement("option", { value: "N" }, "N"),
            React.createElement("option", { value: "P" }, "P"),
            React.createElement("option", { value: "E" }, "E"),
