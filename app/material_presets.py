...
PRESET_CATEGORIES = [
    ("常见化合物", [
        ...
        ("heavy_water",  "重水 (D₂O)",      "H2O: 1",                       "重水，密度 ~1.11 g/cm³\n⚠ 选择后切换到手动 ZAID 模式，将 ¹H（1001）替换为 ²H（1002）"),
    ...
    ("合金 & 特殊材料", [
        ("stainless304","不锈钢 304",        "Fe: 0.686, Cr: 0.19, Ni: 0.095, Mn: 0.02, Si: 0.0075, C: 0.0008", "304 不锈钢，密度 ~8.0 g/cm³"),
        ("stainless316","不锈钢 316",        "Fe: 0.654, Cr: 0.17, Ni: 0.12, Mo: 0.025, Mn: 0.02, Si: 0.0075, C: 0.0008", "316 不锈钢，密度 ~8.0 g/cm³"),
    ...
    ("屏蔽材料", [
        ...
        ("depleted_u",  "贫铀 (DU)",          "U: 1",                         "贫化铀，密度 ~19.1 g/cm³\n⚠ 需切换到手动 ZAID 模式，设 U-238(~99.7%) U-235(~0.3%)"),
    ]),
    ("组织等效材料", [
