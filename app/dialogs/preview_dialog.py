...
class PreviewDialog(QDialog):
    ...
    def _save(self):
        ...
        try:
            ...
            bat_content = (
                "@echo off\n"
                f"{self.mcnp_exe} inp={self.filename} outp=outp.txt\n"
                "pause\n"
            )
    ...
    def _save_as(self):
        ...
        try:
            ...
            bat_name = os.path.splitext(os.path.basename(path))[0] + ".bat"
            bat_content = (
                "@echo off\n"
                f"{self.mcnp_exe} inp={os.path.basename(path)} outp=outp.txt\n"
                "pause\n"
            )
