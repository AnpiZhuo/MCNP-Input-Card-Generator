...
> 日期：2026-08-14 | 状态：**✅ 已交付（2026-08-14 ~ 08-15，v1.7.0 发布；见 `docs/CHANGELOG.md` 2026-08-14 三条施工条目）** —— 原文"本次为契约产出，不施工"为**写作时状态**，2026-09-10 更正。
> 端点数量说明：文中"25→28"为 2026-08-14 当时值（现 api.yaml 共 49 path）；`_err(hint)`、`grid_bounds`/`match`（A1.2）等本契约条款均已落地。
